...
namespace EDUMITRA.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<EDUMITRAExceptionFilterService>();
            services.AddSingleton<ILoggingService, LoggingService>();
            services.AddScoped<IEDUMITRAServiceUser, EDUMITAServiceUser>();
            services.AddMemoryCache();
            //my data
            Audit.Core.Configuration.DataProvider = new SqlDataProvider()
            {
                ConnectionString = EDUMITRAApplicationConfiguration.Instance.FIADB,
                Schema = "dbo",
                TableName = "Event",
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IMemoryCache memoryCache)
        {
           ...
           Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "images")),
            ...
            {
                IEDUMITRAServiceUser serviceUser = context.RequestServices.GetRequiredService<IEDUMITRAServiceUser>();
