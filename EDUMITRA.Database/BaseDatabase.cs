...
{
    public abstract class BaseDatabase : IEDUMITRADatabase
    {
        ...
        public void AutoGenerateInputParams<T>(SqlCommand cmd, T request, IEDUMITRAServiceUser FIAAPIUser, bool IsListRequest = false, bool IsAddEditRequest = false, bool IsIncludeApplicationID = false, bool IsIncludeOrganizationID = false)
        {
            string s = "";
