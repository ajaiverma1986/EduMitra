...
namespace EDUMITRA.Repository
{
    public class ConfigRepository : BaseRepository
    {
        ...
        public async Task<long> AddPaymentAccounts(AddPaymentAccountMasterRequest request, IEDUMITRAServiceUser serviceUser)
        {
        ...
        public async Task<long> changesPaymentAccountsStatus(ChangePaymentAccStatusRequest request, IEDUMITRAServiceUser serviceUser)
        {
        ...
        public async Task<long> CreateNewApplication(CreateapplicationRequest request, string AppToken, IEDUMITRAServiceUser serviceUser)
        {
        ...
        public async Task<long> AddTransactionslab(AddTxnslabRequest request, IEDUMITRAServiceUser serviceUser)
        {
