...
namespace EDUMITRA.Logging
{
    public class LoggingService : ILoggingService
    {
        ...
        public async Task LogMessage(string message, IEDUMITRAServiceUser serviceUser, object moreInfo = null)
        {
            await LogMessage(message, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogMessage(string message, IEDUMITRAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
            Log log = new Log();
            log.Message = message;
        ...
        public async Task LogWarning(List<ErrorResponse> errors, IEDUMITRAServiceUser serviceUser, object moreInfo = null)
        {
            await LogWarning(errors, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogWarning(List<ErrorResponse> errors, IEDUMITRAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
            Log log = new Log();
            await InitializeLog(serviceUser, log);
            await InitializeWarningLog(errors, log);
        ...
        public async Task LogWarning(ErrorResponse error, IEDUMITRAServiceUser serviceUser, object moreInfo = null)
        {
            await LogWarning(error, serviceUser, string.Empty, string.Empty, moreInfo);
        }

        public async Task LogWarning(ErrorResponse error, IEDUMITRAServiceUser serviceUser, string moduleName, string title, object moreInfo = null)
        {
        ...
        public async Task LogError(Exception exception, object loggerClass, IEDUMITRAServiceUser serviceUser, object moreInfo = null)
        {
            Log log = new Log();
            await InitializeLog(serviceUser, log);
            await InitializeErrorLog(exception, log);
        ...
        private async Task InitializeLog(IEDUMITRAServiceUser serviceUser, Log log)
        {
            if (serviceUser != null)
            {
        ...
        private static void InitializeConfigurations()
        {
            ...
            try
            {
                ...
                if (dbTarget != null)
                    dbTarget.ConnectionString = EDUMITRAApplicationConfiguration.Instance.LoggingDB;
